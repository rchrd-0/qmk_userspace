...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		KC_LCTL, KC_LALT, KC_LGUI, KC_LGUI,          KC_SPC,  KC_SPC,  KC_SPC,           KC_RGUI, KC_RGUI, KC_RALT,KC_RCTL
	),
	[1] = LAYOUT(
		...
		KC_CAPS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, NK_TOGG, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_LEFT, KC_RIGHT, KC_TRNS,
